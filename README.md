...
- [Customer Churn App ](#about-project)
...
**Customer Churn App** is a data application that allows users to interact with a machine learning model, view data visualizations on the data and see the values of their input saved for future use.
...
```sh
  cd Customer--Churn-Streamlit-Webapp
...
- Login to the app with `username=modelmaestrosolo` and `password:abc`
...
I would like to thank all the free available resource made available online and Azubi Africa Data Analytics Program
